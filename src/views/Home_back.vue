<template>
  <!-- BEGIN breadcrumb -->
  <body data-bs-spy="scroll" data-bs-target="#header" data-bs-offset="51" class="pace-done "><div class="pace pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="transform: translate3d(100%, 0px, 0px);">
  ...
  <div id="page-container" class="fade show">
    ...
    <!-- begin #home -->
    <div id="home" class="content has-bg home" style="height: 1774px;">
      <!-- begin content-bg -->
      <div class="content-bg" style="background-image: url(/src/assets/img/bg/bg-home.jpg);" data-paroller="true" data-paroller-type="foreground" data-paroller-factor="-0.25">
      </div>
      <!-- end content-bg -->
      <!-- begin container -->
      <div class="container home-content">
        ...
        <h1>사장님,</h1>
        <h1>이런 고민을 겪고 계시지 않았나요?</h1>
        <div class="pill-wrapper">
          <div class="pill-item">제품은 좋은데,<span class="highlight"> 고객이 이해하지 못한다</span>고 느끼시나요? </div>
        </div>
        <div class="pill-wrapper">
          <div class="pill-item">
            웹/앱 경험이 산만해, <span class="highlight">사용자가 이탈</span>하진 않나요?
          </div>
        </div>

        <div class="pill-wrapper">
          <div class="pill-item"><span class="highlight">고객 피드백</span>을 반영하고 있나요?</div>
        </div>

        <h1>전략이 보이는 디자인 </h1>
        <h1>INX와 함께하세요</h1>
        <a href="#" class="btn btn-theme btn-primary">바로 문의하기</a> <br>
        <br>
      </div>
      <!-- end container -->
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="about-author">
              ...
              <div class="author">
                <div class="image">
                  <img src="/src/assets/img/user/user-1.jpg" alt="Sean Ngu">
                </div>
                <div class="info">
                  Sean Ngu
    ...
    <div id="milestone" class="content bg-black-darker has-bg" data-scrollview="true">
      <!-- begin content-bg -->
      <div class="content-bg" style="background-image: url(/src/assets/img/bg/bg-milestone.jpg)"></div>
      <!-- end content-bg -->
      <!-- begin container -->
      <div class="container">
        <!-- begin row -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            ...
            <div class="team">
              <div class="image" data-animation="true" data-animation-type="animate__flipInX">
                <img src="/src/assets/img/user/user-1.jpg" alt="Ryan Teller">
              </div>
              <div class="info">
          ...
          <div class="col-lg-4">
            ...
            <div class="team">
              <div class="image" data-animation="true" data-animation-type="animate__flipInX">
                <img src="/src/assets/img/user/user-2.jpg" alt="Jonny Cash">
              </div>
              <div class="info">
          ...
          <div class="col-lg-4">
            ...
            <div class="team">
              <div class="image" data-animation="true" data-animation-type="animate__flipInX">
                <img src="/src/assets/img/user/user-3.jpg" alt="Mia Donovan">
              </div>
              <div class="info">
    ...
    <div id="quote" class="content bg-black-darker has-bg" data-scrollview="true">
      <!-- begin content-bg -->
      <div class="content-bg" style="background-image: url(/src/assets/img/bg/bg-quote.jpg)" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01">
      </div>
      <!-- end content-bg -->
      <!-- begin container -->
    ...
    <div id="action-box" class="content has-bg" data-scrollview="true">
      <!-- begin content-bg -->
      <div class="content-bg" style="background-image: url(/src/assets/img/bg/bg-action.jpg)" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01">
      </div>
      <!-- end content-bg -->
      <!-- begin container -->
...
<!--          <div class="col-lg-3 col-md-4">
            &lt;!&ndash; begin work &ndash;&gt;
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-1.jpg" alt="Work 1"></a>
              </div>
              <div class="desc">
          ...
          >
            ...
            >
              <div class="work">
                ...
                <div class="desc">
                  <span class="desc-title">Title {{ item.id }}</span>
                  <span class="desc-text">example text</span>
                </div>
              </div>
            </SwiperSlide>
          </Swiper>
...
<!--          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-2.jpg" alt="Work 2"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-3.jpg" alt="Work 3"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-4.jpg" alt="Work 4"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-5.jpg" alt="Work 5"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-6.jpg" alt="Work 6"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-7.jpg" alt="Work 7"></a>
              </div>
              <div class="desc">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="work">
              <div class="image">
                <a href="#"><img src="/src/assets/img/work/work-img-8.jpg" alt="Work 8"></a>
              </div>
              <div class="desc">
...
<!--        </div>-->
    ...
    <div id="client" class="content has-bg bg-green" data-scrollview="true">
      <!-- begin content-bg -->
      <div class="content-bg" style="background-image: url(/src/assets/img/bg/bg-client.jpg)" data-paroller-factor="0.5" data-paroller-factor-md="0.01" data-paroller-factor-xs="0.01">
      </div>
      <!-- end content-bg -->
      <!-- begin container -->
    ...
    <div id="contact" class="content bg-light" data-scrollview="true">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12">
              <button @click="open = true">미리보기</button>
          </div>
          <!-- begin col-6 -->
  ...
  <PortfolioModal v-if="open" @close="open = false"></PortfolioModal>
  <!-- END panel -->
</template>
<script setup>
...
import { useColorAdmin } from '@/assets/js/app.min'
import { Swiper, SwiperSlide } from 'swiper/vue';
import 'swiper/css';
import 'swiper/css/free-mode';
import PortfolioModal from "@/views/modal/portfolioModal.vue";
...
const items = [
  ...
  { id: 4, img: '/src/assets/img/work/work-img-4.jpg' },
  { id: 4, img: '/src/assets/img/work/work-img-4.jpg' },
  { id: 5, img: '/src/assets/img/work/work-img-5.jpg' }
];
...
.pill-item {
  ...
  color: #222;
  line-height: 1.3;
  box-shadow: 0 2px 8px rgba(19, 11, 41, 0.03);
